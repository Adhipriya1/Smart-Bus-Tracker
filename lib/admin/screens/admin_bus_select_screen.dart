...
class _AdminBusSelectScreenState extends State<AdminBusSelectScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Select Bus to Track"),
        backgroundColor: Colors.blue[900], 
        foregroundColor: Colors.white,
      ),
      body: StreamBuilder<List<Map<String, dynamic>>>(
        // Listen to 'buses' table in real-time
        stream: supabase
            .from('buses')
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final plate = bus['license_plate'] ?? "Unknown";
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Row(
                    children: [
                      if (isMoving) ...[
                        ...
                        const Text("seats free", style: TextStyle(color: Colors.green)),
                      ] else 
                  ...
                  onTap: () {
                    // Navigate to the Map Screen focused on this bus
                    Navigator.push(
                      context,
                      MaterialPageRoute(
